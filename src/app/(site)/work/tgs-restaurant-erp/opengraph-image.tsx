...
export const alt =
  "TG's Restaurant ERP — real-time ERP running a delivery-only Ethiopian restaurant in Dubai. Case study by Joseph James (JJ ONYX).";

const SLUG = "tgs-restaurant-erp";
