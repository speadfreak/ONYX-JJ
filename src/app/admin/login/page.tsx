...
export default function AdminLoginPage() {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-onyx-950 px-5">
      {/* ambient texture — quiet, workspace-appropriate */}
      <div aria-hidden className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_50%_at_50%_20%,rgba(212,168,87,0.07),transparent_70%)]" />
      <div
        aria-hidden
      ...
      <div className="relative w-full max-w-md">
        ...
        <p className="mt-7 text-center text-xs leading-relaxed text-muted-foreground">
          Lost access? Contact the builder via the backup channel —{" "}
          <a
            href="mailto:jj@onyx.studio"
            className="text-gold/90 underline decoration-gold/30 underline-offset-4 transition-colors hover:text-gold"
          >
            jj@onyx.studio
          </a>
          . Owner accounts are protected and can never be locked out by the system itself.
        </p>
      </div>
    </main>
  );
